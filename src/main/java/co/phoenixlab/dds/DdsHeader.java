...
public class DdsHeader implements DdsReadable {
     ...
     *
     * @see co.phoenixlab.dds.DdsHeader.Flags
     */
     ...
     *
     * @see co.phoenixlab.dds.DdsHeader.Caps
     */
    private Set<Caps> dwCaps;
    /**
     * Additional detail about the surfaces stored
     *
     * @see co.phoenixlab.dds.DdsHeader.Caps2
     */
    private Set<Caps2> dwCaps2;
    /**
     * Unused
     *
     * @see co.phoenixlab.dds.DdsHeader.Caps3
     */
    private Set<Caps3> dwCaps3;
    /**
     * Unused
     *
     * @see co.phoenixlab.dds.DdsHeader.Caps4
     */
     ...
     * <li>dwFlags contains all the required flags ({@link co.phoenixlab.dds.DdsHeader.Flags#REQUIRED})</li>
     * <li>dwReserved1 is an array of zeros</li>
     * <li>ddspf is valid ({@link DdsPixelFormat#validate()})</li>
     * <li>dwCaps contains all the required caps ({@link co.phoenixlab.dds.DdsHeader.Caps#REQUIRED})</li>
...
//        verifyThat(dwReserved1, i -> Arrays.equals(i, DW_RESERVED_1), "Invalid DDSHeader: dwReserved1 not empty");
        ...
        verifyThat(dwCaps4, Set::isEmpty, "Invalid DDSHeader: dwCaps4 is not empty");
        verifyThat(dwReserved2, i -> i == 0, "Invalid DDSHeader, dwReserved2 not zero");
    }
