...
public class DdsPixelFormat implements DdsReadable {
     ...
     * {@link co.phoenixlab.dds.DdsPixelFormat.Flags#DDPF_RGB},
     * {@link co.phoenixlab.dds.DdsPixelFormat.Flags#DDPF_LUMINANCE}, or
     * {@link co.phoenixlab.dds.DdsPixelFormat.Flags#DDPF_YUV}.
     */
     ...
     * {@link co.phoenixlab.dds.DdsPixelFormat.Flags#DDPF_ALPHAPIXELS} or
     * {@link co.phoenixlab.dds.DdsPixelFormat.Flags#DDPF_ALPHA}.
     */
    ...
    public void validate() throws InvalidDdsException {
        verifyThat(dwSize, i -> i == DW_SIZE, "Invalid DDSPixelFormat: dwSize not " + DW_SIZE);
        verifyThatNot(dwFlags, Set::isEmpty, "Invalid DDSPixelFormat: dwFlags cannot be empty");
    }
